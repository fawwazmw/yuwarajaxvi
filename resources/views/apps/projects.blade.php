@extends('layouts.vertical', ['page_title' => 'Projects', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <div class="col-xl-4">
        ...
        <div class="card-body project-box">
            ...
            <div class="project-members mb-2">
                ...
                <div class="avatar-group">
                    <a href="#" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                        <img src="/images/users/user-5.jpg" class="rounded-circle avatar-sm" alt="friend" />
                    </a>

                    <a href="#" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty">
                        <img src="/images/users/user-6.jpg" class="rounded-circle avatar-sm" alt="friend" />
                    </a>

                    <a href="#" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson">
                        <img src="/images/users/user-7.jpg" class="rounded-circle avatar-sm" alt="friend" />
                    </a>
    ...
    <div class="col-xl-4">
        ...
        <div class="card-body project-box">
            ...
            <div class="project-members mb-2">
                ...
                <div class="avatar-group">
                    <a href="#" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                        <img src="/images/users/user-8.jpg" class="rounded-circle avatar-sm" alt="friend" />
                    </a>

                    <a href="#" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty">
                        <img src="/images/users/user-9.jpg" class="rounded-circle avatar-sm" alt="friend" />
                    </a>

                    <a href="#" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson">
                        <img src="/images/users/user-10.jpg" class="rounded-circle avatar-sm" alt="friend" />
                    </a>
