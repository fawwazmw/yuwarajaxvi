@extends('layouts.vertical', ['page_title' => 'Add Comment', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                    ...
                    <form action="{{ route('comments.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="comment-textarea" rows="5" name="comment" required></textarea>
                                <div class="invalid-feedback">
                        ...
                        <button class="btn btn-primary float-start" type="submit">Add Comment</button>
                    </form>
                </div> <!-- end card-body-->
            </div> <!-- end card-->
        </div><!-- end col -->
