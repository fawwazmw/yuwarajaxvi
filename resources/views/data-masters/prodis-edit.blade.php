@extends('layouts.vertical', ['page_title' => 'Edit Prodi', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="col-12">
            <div class="card">
                <h5 class="card-header">
                    <i class="fas fa-school me-2"></i> EDIT PRODI
                </h5>
                <div class="card-body">
                    @if (session('success'))
                    ...
                    @endif
                    <form action="{{ route('prodis.update', ['id' => $prodi->id]) }}" method="post"
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustomName" name="name"
                                    placeholder="Prodi Name" value="{{ $prodi->name }}" required />
                        ...
                        <button class="btn btn-warning float-start" type="submit">Update Prodi</button>
                    </form>
                </div> <!-- end card-body-->
            </div> <!-- end card-->
        </div><!-- end col -->
