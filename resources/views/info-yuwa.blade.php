...
<body>
    ...
    <div class="body w-100 position-relative overflow-hidden text-start text-white body-parent"
        ...
        <div class="position-absolute animate__animated animate__fadeInUpBig animate__slow button-parent"
            style="
            top: 407px;
            left: 402px;
            width: 309px;
            ...
            cursor: pointer;"
            id="bUTTONContainer">
            <a href="{{ route('infoYuwaList') }}" class="text-decoration-none text-reset">
                <div class="position-absolute top-0 start-0 button-lihat"
                    style="
                background-color: #9b6ba6;
                width: 309px;
                height: 86.2px;
                ...
                transition: background-color 0.3s ease;"
                    ...
                    <div class="position-absolute button-text" style="top: 23.35px; left: calc(50% - 120.37px)">
                        <b>LIHAT BERITA LAIN</b>
                    </div>
                </div>
            </a>
        </div>
        <div class="position-absolute card-parent d-flex flex-wrap justify-content-center"
            ...
            @foreach ($latestAnnouncements as $index => $announcement)
                <div class="animate__animated {{ $index === 0 ? 'animate__bounceInLeft' : 'animate__bounceInRight' }} animate__slow"
