    ...
    <div class="col-sm-8">
        ...
        <div class="bg-picture card-body">
            <div class="d-flex align-items-top">
                <img src="/images/users/profile.jpg"
        ...
        <div class="card-body">
            <div class="d-flex align-items-top mb-2">
                <img src="/images/users/user-1.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                <div class="flex-grow-1">
                    ...
                    <div>
                        <a href="">
                            <img src="/images/small/img-1.jpg" class="avatar-md rounded">
                        </a>
                        <a href="">
                            <img src="/images/small/img-2.jpg" class="avatar-md rounded">
                        </a>
                        <a href="">
                            <img src="/images/small/img-3.jpg" class="avatar-md rounded">
                        </a>
                    </div>
                    ...
                    <div class="d-flex align-items-top mb-2">
                        <img src="/images/users/user-3.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-top">
                        <img src="/images/users/user-4.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-top mb-2">
                                <img src="/images/users/user-5.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                                <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-top mb-3">
                <img src="/images/users/user-6.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-top mb-3">
                <img src="/images/users/user-7.jpg" alt="" class="flex-shrink-0 comment-avatar avatar-sm rounded me-2">
                <div class="flex-grow-1">
