        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="text-center card-body">
                    ...
                    <div>
                        <img src="/images/users/user-10.jpg" class="rounded-circle avatar-xl img-thumbnail mb-2"
                            alt="profile-image">
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="text-center card-body">
                    ...
                    <div>
                        <img src="/images/users/user-9.jpg" class="rounded-circle avatar-xl img-thumbnail mb-2"
                            alt="profile-image">
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="text-center card-body">
                    ...
                    <div>
                        <img src="/images/users/user-8.jpg" class="rounded-circle avatar-xl img-thumbnail mb-2"
                            alt="profile-image">
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="text-center card-body">
                    ...
                    <div>
                        <img src="/images/users/user-7.jpg" class="rounded-circle avatar-xl img-thumbnail mb-2"
                            alt="profile-image">
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="text-center card-body">
                    ...
                    <div>
                        <img src="/images/users/user-6.jpg" class="rounded-circle avatar-xl img-thumbnail mb-2"
                            alt="profile-image">
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="text-center card-body">
                    ...
                    <div>
                        <img src="/images/users/user-5.jpg" class="rounded-circle avatar-xl img-thumbnail mb-2"
                            alt="profile-image">
