                        ...
                        <div class="collapse" id="admin">
                            <ul class="nav-second-level">
                                ...
                                @if (Auth::user()->role !== 'student' && Auth::user()->role !== 'teacher')
                                    <li>
                                        <a href="{{ route('second', ['data-masters', 'clusters']) }}">Cluster
                                            Management</a>
                                    </li>
                                @endif
                                <li>
                    ...
                    <li>
                        ...
                        <div class="collapse" id="sidebarBaseui">
                            <ul class="nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('second', ['ui', 'tooltips-popovers']) }}">Tooltips &
                                        Popovers</a>
                                </li>
                                <li>
                    ...
                    <li>
                        ...
                        <div class="collapse" id="sidebarExtendedui">
                            <ul class="nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('second', ['extended', 'draggable-cards']) }}">Draggable
                                        Cards</a>
                                </li>
                                <li>
