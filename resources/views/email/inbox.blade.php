                        ...
                        <aside id="sidebar">
                            <div class="h-100" data-simplebar>
                                ...
                                <div class="text-center">
                                    <a id="email-left-content" data-bs-toggle='modal' data-bs-target="#custom-modal" class="btn btn-danger rounded-pill width-lg waves-effect waves-light mb-2 mt-3" data-animation="fadein" data-plugin="custommodal" data-overlayColor="#36404a">Compose</a>
                                </div>
                            ...
                            <div id="message-nano-wrapper" class="nano">
                                <div class="nano-content h-100" data-simplebar>
                                    <ul class="message-container list-unstyled">
                                        ...
                                        <li class="received">
                                            <div class="details"> <div class="row">
                                                ...
                                                <!-- End row -->d saying for gathering wherein whose of in
                                                be created stars. Them whales upon life divide earth
                                                own.</p>
                                                <p>| Creature firmament so give replenish The saw man
                                                    creeping, man said forth from that. Fruitful multiply
