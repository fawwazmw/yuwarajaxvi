                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 mt-xl-0 mt-3">
                            ...
                            <div class="button-list">
                                ...
                                <button type="button"
                                    class="btn btn-outline-dark rounded-pill waves-effect waves-light">Dark</button>
                                <button type="button"
                                ...
                                <button type="button"
                                    class="btn btn-outline-light rounded-pill waves-effect">Light</button>
                            </div>
                        </div> <!-- end col -->
                    </div> <!-- end row -->
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-6 mt-xl-0 mt-3">
                            ...
                            <div class="button-list">
                                <button type="button"
                                    class="btn btn-soft-primary rounded-pill waves-effect waves-light">Primary</button>
                                <button type="button"
                                    class="btn btn-soft-success rounded-pill waves-effect waves-light">Success</button>
                                <button type="button"
                                    class="btn btn-soft-info rounded-pill waves-effect waves-light">Info</button>
                                <button type="button"
                                    class="btn btn-soft-warning rounded-pill waves-effect waves-light">Warning</button>
                                <button type="button"
                                    class="btn btn-soft-danger rounded-pill waves-effect waves-light">Danger</button>
                                <button type="button"
                                    class="btn btn-soft-dark rounded-pill waves-effect waves-light">Dark</button>
                                <button type="button"
                                    class="btn btn-soft-pink rounded-pill waves-effect waves-light">Pink</button>
                                <button type="button"
                                    class="btn btn-soft-secondary rounded-pill waves-effect">Secondary</button>
                            </div>
                        </div> <!-- end col -->
                    </div> <!-- end row -->
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <p class="sub-header">
                                Put <code>&lt;span&gt;</code> with class <code>.btn-label</code> and any <code>icon</code>
                                inside it. If you want to
                                put icon on right side then add class <code>.btn-label-right</code> in
                                <code>&lt;span&gt;</code>
                            </p>
                            ...
                            <div class="button-list">
                                ...
                                <button type="button" class="btn btn-danger waves-effect waves-light">
                                    Danger<span class="btn-label-right"><i
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            ...
                            <p class="sub-header">
                                ...
                                <code>.width-sm</code>, <code>.width-md</code>, <code>.width-lg</code> or
                                <code>.width-xl</code>.
                            </p>

                            <div class="button-list">
                                <button type="button"
                                    class="btn btn-primary width-xs waves-effect waves-light">xs</button>
                                <button type="button"
                                    class="btn btn-success width-sm waves-effect waves-light">Small</button>
                                <button type="button"
                                    class="btn btn-info width-md waves-effect waves-light">Middle</button>
                                <button type="button"
                                    class="btn btn-warning width-lg waves-effect waves-light">Large</button>
                                <button type="button" class="btn btn-danger width-xl waves-effect waves-light">Extra
                                    Large</button>
                            </div>
                        </div> <!-- end col -->
                        ...
                        <div class="col-xl-4 mt-xl-0 mt-3">
                            ...
                            <p class="sub-header">
                                Add <code>.btn-lg</code>, <code>.btn-sm</code>, or <code>.btn-xs</code> for additional
                                sizes.
                            </p>

                            <div class="button-list">
                                <button type="button" class="btn btn-pink btn-lg waves-effect waves-light">Btn
                                    Large</button>
                                <button type="button" class="btn btn-secondary waves-effect waves-light">Btn
                                    Normal</button>
                                <button type="button" class="btn btn-primary btn-sm waves-effect waves-light">Btn
                                    Small</button>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <div class="button-list">
                                <button type="button" class="btn btn-success waves-effect waves-light"><i
                                        class="mdi mdi-heart me-1"></i> Like</button>
                                <button type="button" class="btn btn-dark waves-effect waves-light"><i
                                        class="mdi mdi-email-outline me-1"></i> Share</button>
                                <button type="button" class="btn btn-info waves-effect waves-light"><i
                                        class="mdi mdi-cloud-outline me-1"></i> Cloud Hosting</button>
                                <button type="button" class="btn btn-warning waves-effect waves-light">Donate <i
                                        class="mdi mdi-currency-btc ms-1"></i></button>
                            </div>
                            ...
                            <div class="button-list pe-xl-4 d-grid">
                                <button type="button" class="btn btn-lg btn-primary waves-effect waves-light">Block
                                    Button</button>
                                <button type="button" class="btn btn--md btn-pink waves-effect waves-light">Block
                                    Button</button>
