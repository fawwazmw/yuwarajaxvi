                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted">Toasts are as flexible as you need and have very little required markup. At
                                a minimum, we
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-4">
                            ...
                            <p class="text-muted">When you have multiple toasts, we default to vertiaclly stacking them in a
                                readable manner.</p>
                            <div class="p-3">
                                <div aria-live="polite" aria-atomic="true" style="position: relative; min-height: 200px;">
                                    ...
                                    <div class="toast-container" style="position: absolute; top: 0; right: 0;">
                                        ...
                                        <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true"
                                            data-bs-toggle="toast">
                                            <div class="toast-header">
                                                <img src="/images/logo-sm.png" alt="brand-logo" height="12"
                                                    class="me-1" />
                                                <strong class="me-auto">Adminto</strong>
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <p class="text-muted">Place toasts with custom CSS as you need them. The top right is often used
                                for
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="toast fade show d-flex align-items-center text-white bg-primary border-0 mt-4"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="alert alert-info" role="alert">
                        <i class="mdi mdi-alert-circle-outline me-2"></i> A simple info alert with <a href="#"
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="alert alert-dark alert-dismissible bg-dark text-light border-0 fade show mb-0"
                        role="alert">
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="alert"
                            aria-label="Close"></button>
                        This is a dark alert—check it out!
